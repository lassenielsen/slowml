...
do export bgfile=`find backgrounds/ | grep \.vec | shuf | head -n 1`
   ...
   export posy=`echo "print(0.80*float($RANDOM)/32767)" | python`
   export sizex=`echo "print(0.20+(0.80-$posx)*float($RANDOM)/32767)" | python`
   export sizey=`echo "print(0.20+(0.80-$posy)*float($RANDOM)/32767)" | python`
...
do export bgfile=`find backgrounds/ | grep \.vec | shuf | head -n 1`
   export posx=`echo "print(0.85*float($RANDOM)/32767)" | python`
   export posy=`echo "print(0.85*float($RANDOM)/32767)" | python`
   export sizex=`echo "print(0.15+(0.85-$posx)*float($RANDOM)/32767)" | python`
   export sizey=`echo "print(0.15+(0.85-$posy)*float($RANDOM)/32767)" | python`
   export size=`(echo $sizex; echo $sizey;)| sort | head -n 1`;
