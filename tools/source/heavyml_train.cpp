...
{ try
  { if (argc==2 && string("--help")==argv[1] || argc==1)
      throw string("Syntax is heavyml_train [--gd_repetitions|-gdr <int=50000>] [--gd_alphainv|-gda <double=100>] [--gd_lambda|-gdl <double=1>] [--model|-m <modelpath>] [--network|-n <network=\"#features->[3*[3*[all]],[#labels*[all]]]\">] [--networkfile|-nf <path>] [--filename_truths|-fnt <int=0>] [--output|-o <modelpath=./model.pars>] [--continue|-c] [--debug|-d] <datapath>");
    ...
    model->FitParameters(data,truths,gd_alphainv,gd_lambda,gd_repetitions,gd_maxalphainv,option_debug);
